    ...
    <section id="services" className="py-24 section-padding bg-secondary">
      <div className="max-w-[1400px] mx-auto">
        ...
        <p className="font-body text-muted-foreground mt-4 max-w-lg">
          Каждую услугу мастера {siteConfig.name} выполняют точно и внимательно к деталям.
        </p>
          ...
          {siteConfig.services.map((service) => (
            ...
            >
              <div className="flex justify-between items-start gap-4 mb-4">
                <h3 className="font-display text-foreground text-2xl uppercase tracking-wide min-w-0 hyphens-auto break-words">
                  {service.name}
                </h3>
